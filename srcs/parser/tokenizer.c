...
/*   Updated: 2025/03/12 21:24:48 by tcousin          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static char	**ft_expand_and_split_input(char *input, t_minishell *minishell, bool is_heredoc)
{
	char	*expanded_input;
	char	**split_input;
	...
	if (!expanded_input)
		return (NULL);
	split_input = ft_split_with_quotes(expanded_input, ' ', minishell, is_heredoc);
	free(expanded_input);
	return (split_input);
}
